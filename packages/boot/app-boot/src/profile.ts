...
function normalizeShippedProfile(
  ...
  // cannot serve.
  if (isRetiredTuple && !template.bundles.every(packageName => packageDirFromAnchor(installAnchor, packageName) !== undefined)) {
    return manifest
  }
...
export function loadProfile(
  ...
  if (!existsSync(join(dir, 'package.json'))) {
    ...
    initProfile(
      dir,
      template.bundles.filter(packageName => packageDirFromAnchor(installAnchor, packageName) !== undefined),
