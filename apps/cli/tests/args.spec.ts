...
describe('parseDshArgs', () => {
  ...
  it('ends the launcher flags at the first token it does not own', () => {
    ...
    expect(parse(['web', '--host', '127.0.0.1', '--port', '8080', '--open', '--future-web-flag']))
      .toEqual({ mode: 'profile', profile: 'web', patches: [], args: ['--host', '127.0.0.1', '--port', '8080', '--open', '--future-web-flag'] })
